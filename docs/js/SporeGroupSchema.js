 ...
 */
export function getGroupName(groupId, writeDefaultVariant = false, writeDefaultKind = false) {
    /**
    ...
    const variant = (groupId >>> 24) & 0b00111111;
    const entity = (groupId >>> 16) & 0b11111111;
    const kind = (groupId >>> 8) & 0b11111111;
    const num = groupId & 0b11111111;
    let entityName;
    let entityVariants = [];
    let groupName;
    // Entity
 ...
 */
export function combineGroupID(entity, variant, kind, num = 0) {
    if (entity < 0 || entity > 0b11111111
